  ...
  render() {
    return (
      <Tabs onChange={this.onTabChange} type="card" animated>
        <TabPane tab="Load Dimension" key="1">
          <Register
        ...
        <TabPane tab="Define Plans" key="2">
          <DndList {...this.state} />
        </TabPane>
        <TabPane tab="Load Inputs" key="3">
          Content of Tab Pane 3
        </TabPane>
        <TabPane tab="Calculation Engine" key="4">
          Content of Tab Pane 4
        </TabPane>
        <TabPane tab="Result view" key="5">
